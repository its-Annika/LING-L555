...
It then outputs all the types to the monosyllabicBrownTypes.txt in the corpera file.
writeBrownTop reads in from the monosyllabicBrownTypes.txt and prints the top x words.
"""
...
import enchant
import re
from helpers.miscTools import getIPAForm, monosyllabic
...
def gatherTypes():
    ...
    for word in temp:
        ...
        #the only ones we want for the project are a and i
